...
import { GET_EMPLOYEES, GET_LOCATIONS, CREATE_EMPLOYEE, DELETE_EMPLOYEE, GET_EMPLOYEES_BY_DATE } from "@/lib/graphql-queries"
...
export default function AdminEmployeesPage() {
  ...
  // Get locations for the manager (to get locationId)
  const {
    data: locationsData,
    loading: locationsLoading,
    error: locationsError,
  } = useQuery(GET_LOCATIONS, {
    skip: !user?.id || user?.role !== "manager",
    fetchPolicy: "cache-first",
  })


  // Get manager's location id directly from user object (from localStorage)
  const managerLocationId = user?.location_id ? String(user.location_id) : undefined

  // Debugging output
  console.log("[Manager Employees] user:", user)
  console.log("[Manager Employees] locationsData:", locationsData)
  console.log("[Manager Employees] managerLocationId:", managerLocationId)
  ...
  const {
    ...
    variables: { locationId: managerLocationId || undefined },
    skip: !managerLocationId,
    fetchPolicy: "cache-first",
  ...
  console.log("[Manager Employees] employees:", employees)
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex gap-2 ml-2">
                        <Link href={`/dashboard/manager/employee/${employee.id}`}>
                          <Button
                            size="sm"
                            variant="outline"
