...
export default function EmployeeDetailsPage() {
  ...
  const [deleteInfraction] = useMutation(DELETE_INFRACTION, {
    onCompleted: () => {
      refetchDisciplinary()
      refetch()
      toast.success("Infraction supprimée avec succès")
    },
    onError: (error) => {
      toast.error("Erreur lors de la suppression de l'infraction")
      console.error("Error deleting infraction:", error)
    },
  })

  const [deleteAbsence] = useMutation(DELETE_ABSENCE, {
    onCompleted: () => {
      refetchDisciplinary()
      refetch()
  ...
  const [deleteRetard] = useMutation(DELETE_RETARD, {
    onCompleted: () => {
      refetchDisciplinary()
      refetch()
  ...
  const [deleteTenueTravail] = useMutation(DELETE_TENUE_TRAVAIL, {
    onCompleted: () => {
      refetchDisciplinary()
      refetch()
      toast.success("Tenue de travail supprimée avec succès")
    },
    onError: (error) => {
      toast.error("Erreur lors de la suppression de la tenue de travail")
      console.error("Error deleting tenue travail:", error)
    },
  })
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right flex items-start space-x-2">
                              ...
                              <Button
                                ...
                                onClick={() => deleteInfraction({ variables: { id: item.id } })}
                              >
                                <X className="h-4 w-4" />
                              </Button>
                            </div>
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right flex items-start space-x-2">
                              ...
                              <Button
                                ...
                                onClick={() => deleteAbsence({ variables: { id: item.id } })}
                              >
                                <X className="h-4 w-4" />
                              </Button>
                            </div>
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right flex items-start space-x-2">
                              ...
                              <Button
                                ...
                                onClick={() => deleteRetard({ variables: { id: item.id } })}
                              >
                                <X className="h-4 w-4" />
                              </Button>
                            </div>
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right flex items-start space-x-2">
                              ...
                              <Button
                                ...
                                onClick={() => deleteTenueTravail({ variables: { id: item.id } })}
                              >
                                <X className="h-4 w-4" />
                              </Button>
                            </div>
